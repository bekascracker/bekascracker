...
def menu():
    os.system('clear')
    print logo
    print '\x1b[1;97m[1]\x1b[1;97m NUMBER IRAQ'
    print '\x1b[1;97m[2]\x1b[1;97m NUMBER ERBIL'
    print '\x1b[1;97m[3]\x1b[1;97m NUMBER SLEMANI'
    print '\x1b[1;97m[4]\x1b[1;97m NUMBER Kurdistan'
...
def action():
    ...
    time.sleep(0.5)
    psb('[!] Bo Wastan Dne Toolaka Ctrl Z')
    time.sleep(0.5)
    print '\x1b[1;97m--------------------------------------------------'
